pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/mcclela/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('mcclela-225')   // <---- Change this to match your kubernetes cluster credentials
    }
